...
class __TwigTemplate_01db2c595230b57d1bd44211164ec15c18b0dd9bafe09303b478590db6c003bd extends Twig_Template
{
...
\t<dt><label for=\"new_password\">";
        ...
        echo "</span></dt>
\t<dd><input type=\"text\" id=\"new_password\" name=\"new_password\" value=\"\" autocomplete=\"off\" /></dd>
</dl>
<dl>
\t<dt><label for=\"password_confirm\">";
        ...
        echo "</span></dt>
\t<dd><input type=\"text\" id=\"password_confirm\" name=\"password_confirm\" value=\"\" autocomplete=\"off\" /></dd>
</dl>
";
        // line 69
        // line 70
...
";
        ...
        if (( !(isset($context["S_USER_FOUNDER"]) ? $context["S_USER_FOUNDER"] : null) || (isset($context["S_FOUNDER"]) ? $context["S_FOUNDER"] : null))) {
            // line 81
            echo "\t<form id=\"user_quick_tools\" method=\"post\" action=\"";
            echo (isset($context["U_ACTION"]) ? $context["U_ACTION"] : null);
            echo "\">
...
\t\t<dl>
\t\t\t<dt><label for=\"delrates_type\">";
            // line 101
            echo $this->env->getExtension('phpbb')->lang("DEL_RATES_TYPE");
            echo ":</label></dt>
\t\t\t<dd>
\t\t\t\t<label><input name=\"delrates_type\" type=\"radio\" class=\"radio\" value=\"1\" id=\"delrates_type\" /> ";
            // line 103
            echo $this->env->getExtension('phpbb')->lang("DEL_RATES_ONLY_NEGATIVE");
            echo "</label>
\t\t\t\t<label><input name=\"delrates_type\" type=\"radio\" class=\"radio\" value=\"2\" /> ";
            // line 104
            echo $this->env->getExtension('phpbb')->lang("DEL_RATES_ONLY_POSITIVE");
            echo "</label>
\t\t\t\t<label><input name=\"delrates_type\" type=\"radio\" class=\"radio\" value=\"3\" /> ";
            // line 105
            echo $this->env->getExtension('phpbb')->lang("DEL_RATES_BOTH");
            echo "</label>
\t\t\t</dd>
\t\t</dl>
\t\t<dl>
\t\t\t<dt><label for=\"delrates_from\">";
            // line 109
            echo $this->env->getExtension('phpbb')->lang("DEL_RATES_FROM");
            echo ":</label><br /><span>";
            echo $this->env->getExtension('phpbb')->lang("DEL_RATES_FROM_EXPLAIN");
            echo "</span></dt>
\t\t\t<dd><input name=\"delrates_from\" type=\"text\" class=\"text\" maxlength=\"10\" id=\"delrates_from\" value=\"\" /></dd>
\t\t</dl>
\t\t<dl>
\t\t\t<dt><label for=\"delrates_to\">";
            // line 113
            echo $this->env->getExtension('phpbb')->lang("DEL_RATES_TO");
            echo ":</label><br /><span>";
            echo $this->env->getExtension('phpbb')->lang("DEL_RATES_TO_EXPLAIN");
            echo "</span></dt>
...
\t\t\t\t\t<dt><label for=\"delete_type\">";
                ...
                echo "</span></dt>
\t\t\t\t\t<dd><select id=\"delete_type\" name=\"delete_type\"><option value=\"retain\">";
                // line 133
...
\t";
    ...
    {
        return array (  390 => 138,  385 => 136,  377 => 133,  370 => 132,  365 => 130,  359 => 128,  357 => 127,  347 => 120,  343 => 119,  332 => 113,  323 => 109,  316 => 105,  312 => 104,  308 => 103,  303 => 101,  293 => 95,  285 => 91,  278 => 87,  273 => 86,  268 => 84,  261 => 81,  259 => 80,  250 => 74,  245 => 72,  241 => 70,  240 => 69,  231 => 66,  221 => 62,  215 => 59,  210 => 58,  197 => 55,  186 => 54,  179 => 53,  173 => 50,  168 => 49,  163 => 46,  157 => 44,  155 => 43,  148 => 42,  146 => 41,  143 => 40,  137 => 38,  129 => 36,  127 => 35,  120 => 32,  114 => 29,  109 => 28,  106 => 27,  98 => 24,  92 => 23,  87 => 22,  84 => 21,  82 => 20,  77 => 18,  72 => 17,  69 => 16,  63 => 13,  58 => 12,  55 => 11,  53 => 10,  50 => 9,  42 => 8,  38 => 7,  31 => 6,  26 => 4,  19 => 1,);
    }
}
