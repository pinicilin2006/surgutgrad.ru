...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'display_topics' => 'getDisplayTopicsService',
            ...
            'phpbbex.phpbbext.rate_post' => 'getPhpbbex_Phpbbext_RatePostService',
            ...
            'rating.rate' => 'getRating_RateService',
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'phpbb_config_text', $this->get('cache.driver'));
    }
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'surgutgrad', 'zaq1cde3bgt5', 'surgutgrad', '', false, false);
    ...
    /**
     * Gets the 'display_topics' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\display_topics A phpbb\display_topics instance.
     */
    protected function getDisplayTopicsService()
    {
        return $this->services['display_topics'] = new \phpbb\display_topics($this->get('auth'), $this->get('cache'), $this->get('config'), $this->get('content.visibility'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('pagination'), $this->get('request'), $this->get('template'), $this->get('user'), './../', 'php');
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './../', 'adm/', 'php', 'phpbb_log', $this->get('config'));
    }
    ...
    /**
     * Gets the 'phpbbex.phpbbext.rate_post' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpBBex\phpBBext\controller\rate_post A phpBBex\phpBBext\controller\rate_post instance.
     */
    protected function getPhpbbex_Phpbbext_RatePostService()
    {
        return $this->services['phpbbex.phpbbext.rate_post'] = new \phpBBex\phpBBext\controller\rate_post($this->get('user'), $this->get('rating.rate'));
    }
    ...
    {
        return $this->services['plupload'] = new \phpbb\plupload\plupload('./../', $this->get('config'), $this->get('request'), $this->get('user'), $this->get('php_ini'), $this->get('mimetype.guesser'), $this->get('auth'));
    }
    ...
    /**
     * Gets the 'rating.rate' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\rating\rate A phpbb\rating\rate instance.
     */
    protected function getRating_RateService()
    {
        return $this->services['rating.rate'] = new \phpbb\rating\rate($this->get('auth'), $this->get('config'), $this->get('dbal.conn'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'surgutgrad',
            'dbal.dbpasswd' => 'zaq1cde3bgt5',
            'dbal.dbname' => 'surgutgrad',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
