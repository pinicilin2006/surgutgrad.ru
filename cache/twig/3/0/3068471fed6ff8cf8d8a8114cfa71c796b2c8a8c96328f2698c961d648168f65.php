...
/* mcp_topic.html */
class __TwigTemplate_3068471fed6ff8cf8d8a8114cfa71c796b2c8a8c96328f2698c961d648168f65 extends Twig_Template
{
...
\t<h3 id=\"review\">
\t\t<a class=\"right-box\" href=\"#review\" onclick=\"viewableArea(getElementById('topicreview'), true); var rev_text = getElementById('review').getElementsByTagName('a').item(0).firstChild; if (rev_text.data == '";
        // line 91
...
\t\t";
        ...
        // line 179
        echo "\t</select>&nbsp;
\t<input class=\"button1 default-submit-action\" type=\"submit\" name=\"mcp_topic_submit\" value=\"";
        // line 180
