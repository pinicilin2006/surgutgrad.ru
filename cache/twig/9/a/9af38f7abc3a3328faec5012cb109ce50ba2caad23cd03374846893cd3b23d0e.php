...
class __TwigTemplate_9af38f7abc3a3328faec5012cb109ce50ba2caad23cd03374846893cd3b23d0e extends Twig_Template
{
...
";
            ...
            if (twig_length_filter($this->env, $this->getAttribute((isset($context["loops"]) ? $context["loops"] : null), "attachments", array()))) {
                // line 391
                echo "\t<table class=\"table1 zebra-table fixed-width-table manage-attachments-table\">
\t<thead>
\t<tr>
\t\t<th>";
                // line 394
...
\t\t<th style=\"width: 15%;\" class=\"centered-text\">";
                ...
                echo $this->env->getExtension('phpbb')->lang("FILESIZE");
                echo "</th>
\t\t<th class=\"attach-post-id\" style=\"width: 100px\">";
                // line 397
                echo $this->env->getExtension('phpbb')->lang("ATTACH_POST_ID");
                echo "</th>
\t\t<th class=\"attach-to-post\" style=\"width: 15%;\">";
                // line 398
                echo $this->env->getExtension('phpbb')->lang("ATTACH_TO_POST");
                echo "</th>
\t\t<th style=\"width: 120px;\" class=\"centered-text\">";
                // line 399
                echo $this->env->getExtension('phpbb')->lang("DELETE");
                echo "</th>
\t</tr>
...
\t\t\t<td class=\"centered-text\">";
                    ...
                    echo "</td>
\t\t\t<td class=\"attach-post-id\">
\t\t\t\t<input type=\"text\" name=\"post_id[";
                    // line 412
                    echo $this->getAttribute($context["attachments"], "ATTACH_ID", array());
                    echo "]\" size=\"7\" maxlength=\"10\" value=\"";
                    echo $this->getAttribute($context["attachments"], "POST_ID", array());
                    echo "\" ";
                    echo $this->getAttribute($context["attachments"], "DISABLED", array());
                    echo " />
\t\t\t\t<input type=\"hidden\" name=\"current_post_id[";
                    ...
                    echo $this->getAttribute($context["attachments"], "POST_ID", array());
                    echo "\" />
\t\t\t\t<input type=\"hidden\" name=\"current_topic_id[";
                    // line 414
                    echo $this->getAttribute($context["attachments"], "ATTACH_ID", array());
                    echo "]\" value=\"";
                    echo $this->getAttribute($context["attachments"], "TOPIC_ID", array());
                    echo "\" />
\t\t\t</td>
\t\t\t<td class=\"attach-to-post\">";
                    // line 416
                    if ( !$this->getAttribute($context["attachments"], "DISABLED", array())) {
                        echo "<input type=\"checkbox\" class=\"radio\" name=\"add[";
                        echo $this->getAttribute($context["attachments"], "ATTACH_ID", array());
                        echo "]\" />";
                    } else {
                        echo "&nbsp;";
...
\t";
                ...
                // line 420
                echo "\t<tr class=\"row4\">
\t\t<td class=\"attach-post\">&nbsp;</td>
\t\t<td colspan=\"3\">&nbsp;</td>
\t\t<td class=\"small attach-post\"><a href=\"#\" onclick=\"marklist('attachments', 'add', true); return false;\">";
                // line 423
                echo $this->env->getExtension('phpbb')->lang("MARK_ALL");
                echo "</a> :: <a href=\"#\" onclick=\"marklist('attachments', 'add', false); return false;\">";
                echo $this->env->getExtension('phpbb')->lang("UNMARK_ALL");
                echo "</a></td>
\t\t<td class=\"small\"><a href=\"#\" onclick=\"marklist('attachments', 'delete', true); return false;\">";
                // line 424
                echo $this->env->getExtension('phpbb')->lang("MARK_ALL");
                echo "</a> :: <a href=\"#\" onclick=\"marklist('attachments', 'delete', false); return false;\">";
                echo $this->env->getExtension('phpbb')->lang("UNMARK_ALL");
                echo "</a></td>
\t</tr>
\t</tbody>
...
\t\t";
                ...
                if (twig_length_filter($this->env, $this->getAttribute((isset($context["loops"]) ? $context["loops"] : null), "pagination", array()))) {
                    ...
                    $this->loadTemplate("pagination.html", "acp_attachments.html", 438)->display($context);
                    if ($namespace) {
                        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
                    }
                    // line 439
...
";
        ...
        $this->loadTemplate("overall_footer.html", "acp_attachments.html", 473)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
